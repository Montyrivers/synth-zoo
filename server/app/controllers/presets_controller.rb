...
before_action :authorize_request, except: %i[index show]
  ...
  def preset_params
    params.require(:preset).permit(:description, :category, :volume, :amp_attack, :amp_decay, :amp_sustain, :amp_release, :osc_type, :osc_mod, :filter_type, :filter_frequency, :filter_q, :is_mono, :mono_poly, :user_id)
  end
end
